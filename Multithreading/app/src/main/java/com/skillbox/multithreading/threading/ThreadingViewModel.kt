...
class ThreadingViewModel : ViewModel() {
    ...
    private val moviesLiveData = MutableLiveData<List<Movie>>(userRepository.getMovies())
    ...
    fun getMoviesFromRepository(): List<Movie> {
    ...
    fun requestMovies() {
        ...
        userRepository.fetchMovies(movieIds) { movies, fetchTime ->
            ...
            //notify changes
            moviesLiveData.postValue(userRepository.getMovies())
        }
